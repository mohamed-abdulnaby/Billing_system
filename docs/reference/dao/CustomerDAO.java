...
public class CustomerDAO {
    ...
    public Customer create(Customer c) {
        String sql = "INSERT INTO customer (name, address, birthdate, user_id) " +
                     "VALUES (?, ?, ?, ?) RETURNING id";
    ...
    public Customer update(Customer c) {
        String sql = "UPDATE customer SET name = ?, address = ?, birthdate = ? WHERE id = ?";
